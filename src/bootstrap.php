...
if (!function_exists('use_unit')) {
    ...
    function use_unit(string $path): void
    {
        static $unitMap = [
            ...
            'rtl.inc.php' => \VCL\Core\RTL::class,
            'controls.inc.php' => \VCL\UI\Control::class,
            'forms.inc.php' => \VCL\UI\Page::class,
            'stdctrls.inc.php' => \VCL\UI\StdCtrls\Button::class,
            'extctrls.inc.php' => \VCL\UI\ExtCtrls\Panel::class,
            'comctrls.inc.php' => \VCL\UI\ComCtrls\PageControl::class,
            'buttons.inc.php' => \VCL\UI\Buttons\BitBtn::class,
            'menus.inc.php' => \VCL\UI\Menus\MainMenu::class,
